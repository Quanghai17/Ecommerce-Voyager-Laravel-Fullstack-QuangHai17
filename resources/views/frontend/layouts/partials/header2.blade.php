...
<header class="header__section header__transparent">
        ...
        <div class="container">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                <div class="offcanvas__header--menu__open ">
                    <a class="offcanvas__header--menu__open--btn" href="{{ route('cart.index') }}" data-offcanvas>
                ...
                <div class="main__logo">
                    <h1 class="main__logo--title"><a class="main__logo--link" href="{{route('home')}}"><img
                                ...
                                alt="{{ setting('site.title') }}"></a></h1>
                </div>
                <div class="header__search--widget d-none d-lg-block header__sticky--none">
                    <form class="d-flex header__search--form" action="#">
                        <div class="header__select--categories select-01">
                        ...
                        <div class="header__search--box">
                            <form action="{{ route('search') }}" method="get">
                                <label>
                                    <input class="header__search--input" placeholder="Sản phẩm" type="text" name="key">
                                </label>
                                <button class="header__search--button bg__secondary text-white" type="submit">Tìm
                                kiếm</button>
                            </form>
                        </div>
                    </form>
                ...
                <div class="header__right--info d-none d-lg-block d-flex align-items-center">
                    <div class="suport__contact d-flex align-items-center">
                        <svg class="suport__contact--icon text-white" xmlns="http://www.w3.org/2000/svg" style="color: #3cb815 !important;"
                        ...
                        <p class="suport__contact--text text-white" style="color: #3cb815 !important;">
                            <span class="suport__text--24">Mua hàng online</span>
                            <a class="suport__contact--number" href="tel:{{setting('site.phone')}}">{{setting('site.phone')}}</a>
                        </p>
                    </div>
                </div>
            ...
            <div class="header__bottom--inner position__relative d-flex align-items-center">
                <div class="categories__menu">
                    <div class="categories__menu--header text-white d-flex align-items-center">
                        ...
                        <span class="categories__menu--title">Tất cả sản phẩm</span>
                    ...
                    <div class="dropdown__categories--menu">
                        <ul class="d-none d-lg-block">
                            ...
                            <li class="categories__menu--items">
                                <a class="categories__menu--link" href="{{ route('categories.category', $category->slug) }}">
                                     {{$category->name}}
                                </a>
                            </li>
                            @endforeach
                ...
                <div class="header__right--area d-flex justify-content-between align-items-center">
                    <div class="header__menu">
                        <nav class="header__menu--navigation" style="color: aliceblue;">
                            <ul class="d-flex">
                                @foreach ($menu as $item)
                                    @if (count($item->children) > 0)
                                        <li class="header__menu--items">
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="{{route('home')}}">
                    <img src="{{ \TCG\Voyager\Facades\Voyager::image(setting('site.logo')) }}" alt="{{ $pageMeta['title'] ?? setting('site.title') }}" width="158" height="36">
                </a>
            ...
            <nav class="offcanvas__menu">
                ...
                <div class="offcanvas__account--currency">
                    <a class="offcanvas__account--currency__menu text-black" href="{{ route('cart.index') }}">
    ...
    <div class="offcanvas__stikcy--toolbar">
        <ul class="d-flex justify-content-between">
            ...
            <li class="offcanvas__stikcy--toolbar__list ">
                <a class="offcanvas__stikcy--toolbar__btn search__open--btn" href="{{ route('cart.index') }}"
                    data-offcanvas>
                    <span class="offcanvas__stikcy--toolbar__icon">
            ...
            <li class="offcanvas__stikcy--toolbar__list">
                <a class="offcanvas__stikcy--toolbar__btn minicart__open--btn" href="{{ route('cart.index') }}"
                    data-offcanvas>
                    <span class="offcanvas__stikcy--toolbar__icon">
    ...
    <div class="predictive__search--box ">
        <div class="predictive__search--box__inner">
            ...
            <form class="predictive__search--form" action="#">
                <label>
                    <input class="predictive__search--input" placeholder="từ khóa" type="text">
                </label>
